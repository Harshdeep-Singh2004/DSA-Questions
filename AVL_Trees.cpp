...
private:
    ...
    // function to insert a new key into the subtree rooted with node
    ...
    // function to delete a key from the subtree rooted with root
    ...
    // function to search for a key in the subtree rooted with root
